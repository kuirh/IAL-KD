...
def metatrain(teacherdataargs,teacherargs,studentdataargs,studentargs,directargs,ranseed):
    ...
    teacher_executiontime,distill_execution_time,teacher_val_scores,student_val_scores,teacher_best_acc,distill_best_acc,add_val_scores,add_acc,student_similarity,direct_execution_time,direct_val_scores,direct_best_acc,old_val_scores,old_acc,direct_similarity,f_best_acc=distillresnet.train_with_fisher(teacherdataargs, studentdataargs,directdataargs, teacherargs, studentargs,directargs,device,temperature=3, alpha=0.9,
